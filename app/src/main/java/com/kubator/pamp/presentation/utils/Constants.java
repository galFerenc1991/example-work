...
public abstract class Constants {
    ...
    /* STRIPE */
    public static final String STRIPE_TEST_KEY = "pk_test_JjnCq5JreSkRqrcqgInmTDAn";
    public static final String STRIPE_LIVE_KEY = "pk_live_2Dgnw3iEghrBz9T4HWAofHX2";
    ...
    public static final String AUTHORITY = "com.kubator.pamp.provider";
