...
import com.kubator.pamp.presentation.screens.auth.AuthActivity_;
import com.kubator.pamp.presentation.screens.main.profile.about.AboutActivity_;
import com.kubator.pamp.presentation.screens.main.profile.edit_profile.EditProfileActivity_;
import com.kubator.pamp.presentation.screens.main.profile.my_orders.MyOrdersActivity_;
...
public class ProfileFragment extends ContentFragment implements ProfileContract.View {
    ...
    public void openMailSender() {
        ...
        String uriText = "mailto:" + Uri.encode("contact@pamp.fr") +
