...
import com.kubator.pamp.domain.CardRepository;
...
import com.kubator.pamp.presentation.custom.bank_card_inputs.BankCardCVVInputActivity_;
import com.kubator.pamp.presentation.custom.bank_card_inputs.BankCardExpirationInputActivity_;
import com.kubator.pamp.presentation.custom.bank_card_inputs.BankCardNumberInputActivity_;
import com.kubator.pamp.presentation.screens.main.chat.create_order.payment.save_card.SaveCardFragment_;
...
//        Stripe stripe = new Stripe(mActivity, Constants.STRIPE_LIVE_KEY);
    ...
    @Override
    public void closeAddCardScreen(com.kubator.pamp.data.model.common.Card _card) {
